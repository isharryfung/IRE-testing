...
export const api = {
  ...
  createDuplicate: (data) => apiCall('/ire/golden-duplicates', { method: 'POST', body: JSON.stringify(data) }),
  submitDuplicateDecision: (id, data) => apiCall(`/ire/golden-duplicates/${id}/decision`, { method: 'POST', body: JSON.stringify(data) }),
  mergeGolden: (goldenId, data) => apiCall(`/ire/golden/${goldenId}/merge`, { method: 'POST', body: JSON.stringify(data) }),
